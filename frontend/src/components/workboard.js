...
const Workboard = () => {
  ...
  const getShareURL = (boardId) => {
	  return '${window.location.origin}/workspace/${board.boardId}';
  };
  ...
  const viewBoard = () => {
	  ...
	  const shareButton = (boardId) => {
		  const link = getShareURL(boardId);
    ...
    <body className="board_body">
      <div className="toolbar_container">
        <div className="head_container">
		  ...
		  <button onClick={() => shareButton(boardId)}>Share</button>
          <button
